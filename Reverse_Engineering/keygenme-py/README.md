...
What would you like to do, GOUGH (a/b/c/d)? a


SOL is detected as your nearest star.
To which system do you want to travel? alpha
...
(c) Enter License Key
(d) Exit Arcane Calculator
What would you like to do, GOUGH (a/b/c/d)? b
...
(c) Enter License Key
(d) Exit Arcane Calculator
What would you like to do, GOUGH (a/b/c/d)? d
Bye!
```

---

Source code: keygenme-trial.py
...
userhash = hashlib.sha256(b'GOUGH').hexdigest()
key_part_dynamic1_trial = userhash[4] + userhash[5] + userhash[3] + userhash[6] + userhash[2] + userhash[7] + userhash[1] + userhash[8]
key_full_template_trial = key_part_static1_trial + key_part_dynamic1_trial + key_part_static2_trial
