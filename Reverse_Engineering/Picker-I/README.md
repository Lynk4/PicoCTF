...
so let's put 'win' function..........

---
```bash
❯ nc saturn.picoctf.net 56320
Try entering "getRandomNumber" without the double quotes...
==> win
...
```
---
now we get a hexdecimal values let's decode it...
...
# Remove unnecessary parts and split by comma
byte_strings = hex_string.strip("0x").split(",")

# Convert each byte string to integer and then to character
chars = []
